...
- **Protection procs** (Guided Prayer, Well-Honed Instincts, Last Resort, Dream Guide): user ruling BACKLOG #43 — count toward the crisis with "procced, nothing else needed" phrasing.
