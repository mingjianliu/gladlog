...
| **M1**  | Inventory generator (D1) + cooldown compiler parity                                                                                                     | Byte-identical `talentModifiers.json` modulo field order                                                             |
| **M2**  | Decision trace + immutable fact-provider config + decisionDiff (D6) + D5 readiness uncertainty                                                          | Fixtures above; zero diff with identical configs                                                                     |
