...
- **挂起 / 待做**:
  ...
  - #65 第 1 项扩围:连击点缩放的 DoT(撕裂 / 割裂 / 毒伤,DB2 4 s 是 0 点基值)与灌注缩放同形——待用户裁并不并。
