...
- **进度**:Fable 470/470;codex 001–015(347 句);agy(Gemini 3.8 Flash High)补跑的 016–020 太宽松(123 句仅 1 条事实错,codex ≈10%),默认不用。待做:codex 判 016–020 → 新 codex 会话裁分歧(001–015 已有 50 条)→ `score.mjs` 出判定。
