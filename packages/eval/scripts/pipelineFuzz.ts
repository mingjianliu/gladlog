...
// One predicate for "a client-locale name leaked": the production gate
// (checkCjkLeak, hardFailure) and this invariant test the same regex.
import { CJK_LEAK as CJK } from "../src/quality/promptQualityCheck";
