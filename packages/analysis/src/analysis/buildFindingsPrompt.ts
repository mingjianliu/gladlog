...
const CHAIN_LEGENDS: Record<string, string> = {
  ...
  "kick-eaten": `- "kick-eaten": your hardcast (facts.interrupted) was interrupted by facts.source's facts.kick, locking the school for facts.lockout seconds (when known: at cast start, nearest kicker was facts.nearestKickerDistYd yd away, facts.kickersInRange in kick range). Coach positioning and spacing to cast outside enemy kick range, rather than relying solely on fake-casting.`,
